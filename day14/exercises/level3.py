...
def sort_countries(countries, sort_by):
    if sort_by == 'name':
        ...
        raise ValueError("Invalid sort option. Choose 'name', 'capital', or 'population'.")

sorted_by_name = sort_countries(countries_data, 'name')
sorted_by_capital = sort_countries(countries_data, 'capital')
sorted_by_population = sort_countries(countries_data, 'population')
...
most_spoken = most_spoken_languages(countries_data)
...
most_populated = most_populated_countries(countries_data)
